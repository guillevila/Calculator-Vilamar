...
- _"Explícame qué has hecho en lenguaje normal"_ → Claude te cuenta el cambio sin tecnicismos
- _"¿Qué opciones tengo para hacer X?"_ → Claude te da 2-3 alternativas con pros y contras
- _"¿Eso es arriesgado?"_ → Claude te dice si el cambio es reversible o no
- _"Para, esto no es lo que quería"_ → Claude para y pregunta antes de continuar
- _"¿Cuánto esfuerzo es esto?"_ → Claude te da una estimación aproximada
