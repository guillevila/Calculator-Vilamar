...
Use this skill when the user asks to run the migrated source command `nueva-leccion`.
...
4. La añade a `.Codex/skills/lessons-learned/log.md`
...
- La lección debe ser accionable — que Codex sepa exactamente qué hacer diferente
