...
Ejemplo: _"feat: añadir pantalla de login"_
...
de la API.
Ejemplo: _"Cuando el conductor guarda un parte, el frontend envía los datos
al backend a través de la API, y el backend los guarda en la base de datos."_
...
_¿Falta algún término? Díselo a Claude: "Añade [término] al diccionario"_
